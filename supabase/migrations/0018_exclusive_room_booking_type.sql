...
begin
  ...
  select capacity, active, allows_hourly, hourly_duration_hours into v_capacity, v_active, v_allows_hourly, v_duration from room_types where id = p_room_type_id;
